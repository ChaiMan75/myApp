...
const Hero = () => {
  return (
    <section id="home" className="pt-24 md:pt-32 pb-16 bg-gradient-to-br from-orange-100/10 via-green-100/10 to-blue-100/10">
        ...
        <div className="flex flex-wrap items-center">
          <div className="w-full lg:w-1/2 mb-10 lg:mb-0">
            <h1 className="font-heading font-bold text-4xl md:text-5xl lg:text-6xl mb-4 text-neutral-800">
              ...
              Heal with <span className="text-green-500">Heart.</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              <Button asChild size="lg" className="bg-primary hover:bg-orange-600 text-white font-heading tracking-wide uppercase font-semibold rounded-full transition transform hover:-translate-y-1 hover:shadow-md">
